...
class Keypad {
 public:
  Keypad(char* k, int a, int b, int c, int d) {}
...
void drawnokiascreen(String sEnteredTrack) {
    Serial.print("\n\n================");
    Serial.print("\nENTER TRACK #");
    Serial.print(sEnteredTrack);                // Put entered number on Nokia lcd    
    Serial.print("cur-pos:");
    Serial.print(sCurrentPosition);             //  Display current position of stepper
}
